...
import com.example.FinanceTracker.user.dto.JwtResponse;
import com.example.FinanceTracker.user.dto.RegistrationUserDto;
import com.example.FinanceTracker.user.dto.UserDto;
import com.example.FinanceTracker.user.entities.User;
import com.example.FinanceTracker.user.exceptions.AppError;
...
public class AuthService {
    ...
    public ResponseEntity<?> createAuthToken(@RequestBody JwtRequest authRequest) {
        try {
            ...
            return new ResponseEntity<>(new AppError(HttpStatus.UNAUTHORIZED.value(), "Incorrect login or paswword"), HttpStatus.UNAUTHORIZED);
        }
